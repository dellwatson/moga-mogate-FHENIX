...
async function main() {
  ...
  // 3. Deploy TestMGC
  console.log("\n3. Deploying TestMGC...");
  const testmgcArtifact = require("/Users/dellwatson/Desktop/MOGATE_DEFI/mogate-rwa-raffle-monorepo-ETH/artifacts/contracts/ERC721.sol/TestMGC.json");
  ...
  // 4. Deploy MyToken
  console.log("\n4. Deploying MyToken...");
  const mytokenArtifact = require("/Users/dellwatson/Desktop/MOGATE_DEFI/mogate-rwa-raffle-monorepo-ETH/artifacts/contracts/simplERC721.sol/MyToken.json");
